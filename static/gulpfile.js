      ...
      css: {
        ...
        render: {
          scss: {
            ...
            template: project.spriteTemplate + "/sprite-template.scss"
          }
        }
      }
    },
 ...
 */
gulp.task('watch', ['clean', 'sass-compile', 'js', 'js-lib', 'js-assets', 'js-managers', 'generate-svg-sprite'], function () {
  if (project.browserSync.enabled) {
    browserSync.init({
      server: './',
  ...
  gulp.watch(project.paths.sprite.src, ['generate-svg-sprite']);
});
